...
The workflow contains customer rules, internal identifiers, personal memory, private source profiles or methods distilled from non-public collaboration. It is not published. Transferable lessons may be rewritten as an article without exposing the original files.
